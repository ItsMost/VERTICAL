                              ...
                              <div className="flex flex-col md:flex-row items-stretch md:items-center gap-3 relative mb-4">
                                ...
                                >
                                  ...
                                  {duration > 0 && takeoffTime > 0 && (
                                    ...
                                    >
                                      <div className="absolute -top-3 left-1/2 -translate-x-1/2 px-2 py-0.5 bg-cyan-500 text-[#070a13] text-[9px] font-black rounded border border-cyan-300 shadow-[0_0_8px_rgba(6,182,212,0.6)] flex items-center gap-0.5 whitespace-nowrap">
                                        🚀 إقلاع
                                      </div>
                                    </div>
                                  )}
                                  ...
                                  {duration > 0 && landingTime > 0 && (
                                    ...
                                    >
                                      <div className="absolute -bottom-3 left-1/2 -translate-x-1/2 px-2 py-0.5 bg-red-500 text-white text-[9px] font-black rounded border border-red-400 shadow-[0_0_8px_rgba(239,68,68,0.6)] flex items-center gap-0.5 whitespace-nowrap">
                                        🛬 هبوط
                                      </div>
                                    </div>
                                  )}

                                  {/* Touchdown Marker (if DJ) */}
                                  {duration > 0 && jumpType === 'dj' && boxTouchdownTime > 0 && (
                                    ...
                                    >
                                      <div className="absolute -top-3 left-1/2 -translate-x-1/2 px-2 py-0.5 bg-blue-500 text-white text-[9px] font-black rounded border border-blue-400 shadow-[0_0_8px_rgba(59,130,246,0.6)] flex items-center gap-0.5 whitespace-nowrap">
                                        📥 تلامس
                                      </div>
                                    </div>
                                  )}
