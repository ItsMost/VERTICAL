...
export const MacbookScroll = ({
  ...
  return (
    <div
      ref={ref}
      className="flex min-h-[140vh] shrink-0 scale-[0.4] transform flex-col items-center justify-start py-0 [perspective:800px] sm:scale-50 md:scale-90 md:py-40"
    >
      <motion.h2
        style={{
      ...
      >
        {title || (
          <span>
            This Macbook Showcase is built for VERTICAL LAB <br /> High Performance Biomechanics
          </span>
        )}
      </motion.h2>
      {/* Lid */}
      ...
      {/* Base area */}
      <div className="relative -z-10 h-[22rem] w-[32rem] overflow-hidden rounded-2xl bg-gray-200 dark:bg-[#272729] border border-cyan-500/20 shadow-2xl">
        {/* above keyboard bar */}
  ...
  return (
    <div className="relative [perspective:800px]">
      <div
        ...
        className="relative h-[12rem] w-[32rem] rounded-2xl bg-[#010101] p-2 border border-cyan-500/30"
      >
        <div
          style={{
      ...
      <motion.div
        ...
        className="absolute inset-0 h-96 w-[32rem] rounded-2xl bg-[#010101] p-2 shadow-2xl border border-cyan-500/40"
      >
        <div className="absolute inset-0 rounded-lg bg-[#050711] overflow-hidden" />
        {src ? (
          <img
            src={src}
            alt="screen content"
          ...
          <div className="absolute inset-0 h-full w-full rounded-lg overflow-y-auto bg-black p-3 font-sans">
            {children}
          </div>
        ) : (
          <div className="absolute inset-0 flex items-center justify-center text-cyan-400 font-mono font-bold text-sm">
            VERTICAL LAB SCREEN
          </div>
        )}
      </motion.div>
  ...
  return (
    <div className="mx-1 h-full [transform:translateZ(0)] rounded-md bg-[#050505] p-1 [will-change:transform]">
      ...
      <div className="mb-[2px] flex w-full shrink-0 gap-[2px]">
        <KBtn className="w-10 items-end justify-start pb-[2px] pl-[4px]">esc</KBtn>
        ...
        <KBtn><Table className="h-[6px] w-[6px]" /><span className="mt-1 inline-block">F3</span></KBtn>
        ...
        <KBtn><Volume className="h-[6px] w-[6px]" /><span className="mt-1 inline-block">F7</span></KBtn>
        <KBtn><Volume1 className="h-[6px] w-[6px]" /><span className="mt-1 inline-block">F8</span></KBtn>
        <KBtn><Volume2 className="h-[6px] w-[6px]" /><span className="mt-1 inline-block">F9</span></KBtn>
        <KBtn><Volume2 className="h-[6px] w-[6px]" /><span className="mt-1 inline-block">F10</span></KBtn>
      ...
      {/* Third row */}
      <div className="mb-[2px] flex w-full shrink-0 gap-[2px]">
        <KBtn className="w-10 items-end justify-start pb-[2px] pl-[4px]">tab</KBtn>
      ...
      {/* Fourth Row */}
      <div className="mb-[2px] flex w-full shrink-0 gap-[2px]">
        <KBtn className="w-[2.8rem] items-end justify-start pb-[2px] pl-[4px]">caps lock</KBtn>
      ...
      {/* Fifth Row */}
      <div className="mb-[2px] flex w-full shrink-0 gap-[2px]">
        <KBtn className="w-[3.65rem] items-end justify-start pb-[2px] pl-[4px]">shift</KBtn>
